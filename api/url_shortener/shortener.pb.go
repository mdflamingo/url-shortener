...
// 	protoc        v7.34.1
// source: api/url_shortener/shortener.proto
...
func (x *URLShortenRequest) Reset() {
	*x = URLShortenRequest{}
	mi := &file_api_url_shortener_shortener_proto_msgTypes[0]
...
func (x *URLShortenResponse) Reset() {
	*x = URLShortenResponse{}
	mi := &file_api_url_shortener_shortener_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLExpandRequest) Reset() {
	*x = URLExpandRequest{}
	mi := &file_api_url_shortener_shortener_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLExpandResponse) Reset() {
	*x = URLExpandResponse{}
	mi := &file_api_url_shortener_shortener_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UserURLsResponse) Reset() {
	*x = UserURLsResponse{}
	mi := &file_api_url_shortener_shortener_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLData) Reset() {
	*x = URLData{}
	mi := &file_api_url_shortener_shortener_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_api_url_shortener_shortener_proto protoreflect.FileDescriptor

const file_api_url_shortener_shortener_proto_rawDesc = "" +
	"\n" +
	"!api/url_shortener/shortener.proto\x12\x18mdflamingo.url_shortener\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\x03url\x18\x01 \x03(\v2!.mdflamingo.url_shortener.URLDataR\x03url\"I\n" +
	"\aURLData\x12\x1b\n" +
	"\tshort_url\x18\x01 \x01(\tR\bshortUrl\x12!\n" +
	"\foriginal_url\x18\x02 \x01(\tR\voriginalUrl2\xb5\x02\n" +
	"\x10ShortenerService\x12g\n" +
	"\n" +
	"ShortenURL\x12+.mdflamingo.url_shortener.URLShortenRequest\x1a,.mdflamingo.url_shortener.URLShortenResponse\x12d\n" +
	"\tExpandURL\x12*.mdflamingo.url_shortener.URLExpandRequest\x1a+.mdflamingo.url_shortener.URLExpandResponse\x12R\n" +
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a*.mdflamingo.url_shortener.UserURLsResponseB7Z5github.com/mdflamingo/url-shortener/api/url_shortenerb\beditionsp\xe8\a"

var file_api_url_shortener_shortener_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_url_shortener_shortener_proto_goTypes = []any{
	(*URLShortenRequest)(nil),  // 0: mdflamingo.url_shortener.URLShortenRequest
	(*URLShortenResponse)(nil), // 1: mdflamingo.url_shortener.URLShortenResponse
	(*URLExpandRequest)(nil),   // 2: mdflamingo.url_shortener.URLExpandRequest
	(*URLExpandResponse)(nil),  // 3: mdflamingo.url_shortener.URLExpandResponse
	(*UserURLsResponse)(nil),   // 4: mdflamingo.url_shortener.UserURLsResponse
	(*URLData)(nil),            // 5: mdflamingo.url_shortener.URLData
	(*emptypb.Empty)(nil),      // 6: google.protobuf.Empty
}
var file_api_url_shortener_shortener_proto_depIdxs = []int32{
	5, // 0: mdflamingo.url_shortener.UserURLsResponse.url:type_name -> mdflamingo.url_shortener.URLData
	0, // 1: mdflamingo.url_shortener.ShortenerService.ShortenURL:input_type -> mdflamingo.url_shortener.URLShortenRequest
	2, // 2: mdflamingo.url_shortener.ShortenerService.ExpandURL:input_type -> mdflamingo.url_shortener.URLExpandRequest
	6, // 3: mdflamingo.url_shortener.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	1, // 4: mdflamingo.url_shortener.ShortenerService.ShortenURL:output_type -> mdflamingo.url_shortener.URLShortenResponse
	3, // 5: mdflamingo.url_shortener.ShortenerService.ExpandURL:output_type -> mdflamingo.url_shortener.URLExpandResponse
	4, // 6: mdflamingo.url_shortener.ShortenerService.ListUserURLs:output_type -> mdflamingo.url_shortener.UserURLsResponse
...
func init() { file_api_url_shortener_shortener_proto_init() }
func file_api_url_shortener_shortener_proto_init() {
	if File_api_url_shortener_shortener_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_url_shortener_shortener_proto_rawDesc), len(file_api_url_shortener_shortener_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_url_shortener_shortener_proto_goTypes,
		DependencyIndexes: file_api_url_shortener_shortener_proto_depIdxs,
		MessageInfos:      file_api_url_shortener_shortener_proto_msgTypes,
	}.Build()
	File_api_url_shortener_shortener_proto = out.File
	file_api_url_shortener_shortener_proto_goTypes = nil
	file_api_url_shortener_shortener_proto_depIdxs = nil
}
